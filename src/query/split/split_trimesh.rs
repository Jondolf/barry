...
use crate::math::{AnyVector, Isometry, Real, UnitVector, Vector};
...
impl Triangulation {
    fn new(axis: UnitVector, basis_origin: Vector) -> Self {
        Triangulation {
...
impl TriMesh {
    ...
    pub fn canonical_split(&self, axis: usize, bias: Real, epsilon: Real) -> SplitResult<Self> {
        // TODO: optimize this.
        self.local_split(
            UnitVector::new(Vector::ith(axis, 1.0)).unwrap(),
            bias,
            epsilon,
        )
    }
    ...
    pub fn canonical_intersection_with_plane(
        ...
        self.intersection_with_local_plane(
            UnitVector::new(Vector::ith(axis, 1.0)).unwrap(),
            bias,
            epsilon,
        )
    ...
    pub fn intersection_with_aabb(
        ...
        let cuboid_pos = Isometry::from_translation(aabb.center());
